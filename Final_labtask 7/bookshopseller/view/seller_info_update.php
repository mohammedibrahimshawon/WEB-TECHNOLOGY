...
function validateForm() {
  ...
  var a6 = document.forms["myForm"]["password"].value;
  if (a == "" ) {
...
<div class="main_content">
    <div class="header">Upate Profile Info</div>  
        ...
        <b>Email:</b>&nbsp;&nbsp;&nbsp;<input type="text" id="email" name="email" value=<?=$sellerEmail?>> <p id="errorMsg"></p> 


        <b>Contact No:</b>&nbsp;&nbsp;&nbsp;<input type="text" id="contact" name="contact" value=<?=$sellerContact ?>> <p id="errorMsg1"></p> 

        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Gender:</b>&nbsp;&nbsp;&nbsp;<input type="text" id="gender" name="gender" value=<?=$sellerGender?>> <p id="errorMsg2"></p> 

        <b>National ID:</b>&nbsp;&nbsp;&nbsp;<input type="text" id="nid" name="nid" value=<?=$sellerNID?>> <p id="errorMsg3"></p>

        &nbsp;&nbsp;&nbsp;<b>User Type:</b>&nbsp;&nbsp;&nbsp;<input type="text" id="type" name="type" value=<?=$sellerType ?>> <p id="errorMsg4"></p> 

        <b>Date of Birth:</b>&nbsp;&nbsp;<input type="text" id="dob" name="dob" value=<?=$sellerDOB?>> <p id="errorMsg5"></p> <

         <b>User Password:</b>&nbsp;&nbsp;&nbsp;<input type="password" id="password" name="password" value=<?=$password?>> <p id="errorMsg"></p> 
